...
class pathMaker :
    ...
    def __init__(self, pkg_name, path_name):
        ...
        rospy.Subscriber('/ground_truth',Odometry, self.status_callback)
        # rospy.Subscriber('/gmcl_pose',PoseWithCovarianceStamped, self.status_callback)
        # 초기화
        self.prev_x = 0
        self.prev_y = 0
...
if __name__ == '__main__' :
    try:
        p_m=pathMaker("path_planning", "kmu_in_path")
